<x-frontend-layout>
    ...
    <section class="bg-[#F8F8F8] py-20 border-b border-gray-150">
        <div class="max-w-4xl mx-auto px-6 text-center space-y-6">
            <span class="text-xs font-bold text-zinc-600 uppercase tracking-widest block">Agency Expertise</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($services as $service)
                    <div class="bg-[#F8F8F8] p-8 rounded-3xl hover:shadow-2xl transition duration-300 flex flex-col justify-between group space-y-6" data-aos="fade-up">
                        <div class="space-y-4">
                            <div class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-zinc-800 shadow-sm group-hover:bg-zinc-800 group-hover:text-white transition duration-300">
                        ...
                        <a href="/services/{{ $service->slug }}" class="inline-flex items-center space-x-1.5 text-xs font-bold text-[#111111] hover:text-black transition pt-4">

<x-frontend-layout>
    <!-- Page Container -->
    <div class="relative overflow-hidden bg-[#FAFAFA] min-h-[calc(100vh-80px)] flex items-center py-12 lg:py-16 selection:bg-[#FF6A00] selection:text-white">
        
        <!-- Decorative subtle orange gradient glow in background -->
        <div class="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#FF6A00]/5 rounded-full blur-[100px] pointer-events-none"></div>
                ...
                <div class="lg:col-span-5 flex flex-col justify-between space-y-12">
                    ...
                    <div class="space-y-6 pt-8 border-t border-[#ECECEC]">
                        ...
                        <div class="flex items-start space-x-4">
                            <div class="p-2.5 border border-[#ECECEC] rounded-[10px] text-[#FF6A00] bg-[#FAFAFA]">
                ...
                <div class="lg:col-span-7">
                    ...
                    <form method="POST" action="{{ route('contact.submit') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <!-- Your Name -->
                            <div class="space-y-2">
                                <label for="name" class="text-[13px] font-medium text-[#111111]">Your Name <span class="text-[#FF6A00]">*</span></label>
                                <input type="text" name="name" id="name" required placeholder="Enter your name" 
                                       class="w-full bg-white border border-[#ECECEC] rounded-[12px] h-[54px] px-5 text-[14px] text-[#111111] placeholder:text-gray-400 focus:border-[#FF6A00] focus:ring-1 focus:ring-[#FF6A00] transition duration-300 outline-none">
                            </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="service_interest" id="service_interest"
                                    class="w-full bg-white border border-[#ECECEC] rounded-[12px] h-[54px] px-5 text-[14px] text-[#111111] focus:border-[#FF6A00] focus:ring-1 focus:ring-[#FF6A00] transition duration-300 outline-none">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="message" id="message" rows="5" required placeholder="Write a few lines about your project, goals and requirements..." 
                                      class="w-full bg-white border border-[#ECECEC] rounded-[12px] p-5 text-[14px] text-[#111111] placeholder:text-gray-400 focus:border-[#FF6A00] focus:ring-1 focus:ring-[#FF6A00] transition duration-300 outline-none resize-none"></textarea>
                        </div>

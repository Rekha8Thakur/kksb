            ...
            <form method="POST" action="{{ route('admin.brand-videos.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="platform" id="platform"
                        ...
                        <option value="" {{ old('platform') === '' ? 'selected' : '' }}>Select Platform</option>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g. NOBLE SOLAR"
                           class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description') }}" placeholder="e.g. Solar & Renewable Energy"
                           class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="url" name="video_url" id="video_url" value="{{ old('video_url') }}" placeholder="e.g. https://www.instagram.com/reel/... or https://youtu.be/..."
                           class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">

<x-admin-layout>
    <x-slot name="title">Write New Post</x-slot>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-zinc-400">
            ...
            <span>/</span>
            <span class="text-gray-900 dark:text-white font-semibold">New Article</span>
        </div>

        <div>
            <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Write Blog Post</h1>
            <p class="text-sm text-gray-500 dark:text-zinc-400">Create a rich text blog article with search optimization metadata.</p>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-gray-200 dark:border-zinc-800 shadow-sm p-6 lg:p-8">
            <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g., How to Grow Your Restaurant Brand in 2026" required
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="summary" id="summary" rows="2" placeholder="Brief outline shown in lists (approx 150 characters)..."
                              class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('summary') }}</textarea>
                </div>
                ...
                <div class="border-t border-gray-100 dark:border-zinc-800 pt-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" placeholder="Custom browser tab title..."
                                   class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="seo_keywords" id="seo_keywords" value="{{ old('seo_keywords') }}" placeholder="e.g. food marketing, reels tips, solan cafes"
                                   class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="seo_description" id="seo_description" rows="2" placeholder="Custom snippet shown in search engine listings..."
                                  class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('seo_description') }}</textarea>
                    </div>
                </div>

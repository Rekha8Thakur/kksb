                ...
                <div x-show="tab === 'general'" class="space-y-6">
                    ...
                    <div class="border-t border-gray-100 dark:border-zinc-800/60 pt-6 mt-6">
                        ...
                        <div class="space-y-2 mt-4">
                            <label class="text-sm font-semibold text-gray-700 dark:text-zinc-300">SEO Default Description</label>
                            <textarea name="seo_description" rows="3" placeholder="KKSB Studios is a premium creative agency based in Himachal Pradesh specializing in video production, social media management, brand strategy, and web design." class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">{{ App\Models\Setting::get('seo_description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-gray-700 dark:text-zinc-300">Careers Apply Now Button State (Join Us Page)</label>
                        <select name="disable_careers_apply_btn" class="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-300 dark:border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:ring-emerald-500 focus:border-emerald-500">
                            <option value="0" {{ App\Models\Setting::get('disable_careers_apply_btn', '0') == '0' ? 'selected' : '' }}>Enabled (Normal Link)</option>
                            <option value="1" {{ App\Models\Setting::get('disable_careers_apply_btn', '0') == '1' ? 'selected' : '' }}>Disabled (Show 'No Open Positions' Popup)</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @if($path = App\Models\Setting::get('home_hero_bg'))
                            <div class="flex items-center space-x-3 mb-2">
                                <img src="{{ asset($path) }}" class="w-20 h-10 object-cover rounded border border-gray-300" alt="" loading="lazy">

                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-zinc-850/30">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end space-x-3">
                                            ...
                                            <button type="button" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this FAQ?')) { const f = document.getElementById('global-delete-form'); f.action = '{{ route('admin.faqs.destroy', $faq) }}'; f.submit(); }" class="p-1 text-gray-500 hover:text-rose-600 transition">

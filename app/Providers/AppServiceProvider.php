...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        if (file_exists($siblingPublicHtml) && file_exists($siblingPublicHtml . '/index.php') && realpath($siblingPublicHtml) !== realpath(base_path())) {
            $this->app->usePublicPath($siblingPublicHtml);
        } else {
            $parentPublicHtml = base_path('../public_html');
            if (file_exists($parentPublicHtml) && file_exists($parentPublicHtml . '/index.php') && realpath($parentPublicHtml) !== realpath(base_path())) {
